...
namespace SchematicHQ.Client.Test.RulesEngine
{
  public static class TestHelpers
  {
    ...
    public static RulesengineTrait CreateTestTrait(string value, RulesengineTraitDefinition? traitDefinition)
    {
      ...
      {
        traitDefinition = CreateTestTraitDefinition(RulesengineTraitDefinitionComparableType.String, RulesengineEntityType.Company);
      }
    ...
    public static RulesengineTraitDefinition CreateTestTraitDefinition(RulesengineTraitDefinitionComparableType comparableType, RulesengineEntityType entityType)
    {
