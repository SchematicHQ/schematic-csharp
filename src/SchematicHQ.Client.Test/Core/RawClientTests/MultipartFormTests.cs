...
namespace SchematicHQ.Client.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static SchematicHQ.Client.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new SchematicHQ.Client.Core.MultipartFormRequest
        {
