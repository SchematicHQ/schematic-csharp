...
public class ListBillingProductPricesTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/billing/product/prices")
        ...
        var response = await Client.Billing.ListBillingProductPricesAsync(
