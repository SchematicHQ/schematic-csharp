...
public class CancelSubscriptionTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/manage-plan/subscription/cancel")
        ...
        var response = await Client.Checkout.CancelSubscriptionAsync(
