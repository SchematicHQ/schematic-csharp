...
public class GetPlanEntitlementTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/plan-entitlements/plan_entitlement_id")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Entitlements.GetPlanEntitlementAsync("plan_entitlement_id");
