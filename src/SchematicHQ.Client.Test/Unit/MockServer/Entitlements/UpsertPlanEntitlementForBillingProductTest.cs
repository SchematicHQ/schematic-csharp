...
public class UpsertPlanEntitlementForBillingProductTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/plan-entitlements/billing-linked")
        ...
        var response = await Client.Entitlements.UpsertPlanEntitlementForBillingProductAsync(
