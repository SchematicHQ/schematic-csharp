...
public partial class DataexportsClient : IDataexportsClient
{
    ...
    private async Task<WithRawResponse<ListDataExportsResponse>> ListDataExportsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListDataExportsResponse>(responseBody)!;
                return new WithRawResponse<ListDataExportsResponse>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<GetDataExportResponse>> GetDataExportAsyncCore(
        string dataExportId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetDataExportResponse>(responseBody)!;
                return new WithRawResponse<GetDataExportResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ListDataExportsResponse> ListDataExportsAsync(
        ListDataExportsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListDataExportsResponse>(
    ...
    /// </code></example>
    public WithRawResponseTask<GetDataExportResponse> GetDataExportAsync(
        string dataExportId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetDataExportResponse>(
