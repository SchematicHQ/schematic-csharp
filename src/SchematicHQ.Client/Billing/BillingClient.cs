...
public partial class BillingClient : IBillingClient
{
    ...
    private async Task<WithRawResponse<DeleteBillingCouponResponse>> DeleteBillingCouponAsyncCore(
        string billingId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DeleteBillingCouponResponse>(
                    responseBody
                )!;
                return new WithRawResponse<DeleteBillingCouponResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<DeleteBillingCustomerResponse>
    > DeleteBillingCustomerAsyncCore(
        string billingId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DeleteBillingCustomerResponse>(
                    responseBody
                )!;
                return new WithRawResponse<DeleteBillingCustomerResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<DeleteBillingInvoiceResponse>> DeleteBillingInvoiceAsyncCore(
        string billingId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DeleteBillingInvoiceResponse>(
                    responseBody
                )!;
                return new WithRawResponse<DeleteBillingInvoiceResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<ListCompanyBillingProfilesResponse>
    > ListCompanyBillingProfilesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListCompanyBillingProfilesResponse>(
                    responseBody
                )!;
                return new WithRawResponse<ListCompanyBillingProfilesResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<UpdateCompanyBillingProfileResponse>
    > UpdateCompanyBillingProfileAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    ...
                    Path = string.Format(
                        "billing/profiles/{0}",
                        ValueConvert.ToPathParameterString(billingProfileId)
                    ),
                    Body = request,
                    QueryString = _queryString,
                    Headers = _headers,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<UpdateCompanyBillingProfileResponse>(
                    responseBody
                )!;
                return new WithRawResponse<UpdateCompanyBillingProfileResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<DeleteBillingCouponResponse> DeleteBillingCouponAsync(
        string billingId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DeleteBillingCouponResponse>(
            DeleteBillingCouponAsyncCore(billingId, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<DeleteBillingCustomerResponse> DeleteBillingCustomerAsync(
        string billingId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DeleteBillingCustomerResponse>(
            DeleteBillingCustomerAsyncCore(billingId, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<DeleteBillingInvoiceResponse> DeleteBillingInvoiceAsync(
        string billingId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DeleteBillingInvoiceResponse>(
            DeleteBillingInvoiceAsyncCore(billingId, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ListCompanyBillingProfilesResponse> ListCompanyBillingProfilesAsync(
        ListCompanyBillingProfilesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListCompanyBillingProfilesResponse>(
            ListCompanyBillingProfilesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<UpdateCompanyBillingProfileResponse> UpdateCompanyBillingProfileAsync(
        string billingProfileId,
        UpdateCompanyBillingProfileRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateCompanyBillingProfileResponse>(
            UpdateCompanyBillingProfileAsyncCore(
                billingProfileId,
                request,
                options,
