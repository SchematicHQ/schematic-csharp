...
[Serializable]
public record ListBillingProductPricesRequest
{
    /// <summary>
    ...
    [JsonIgnore]
    public ListBillingProductPricesRequestTiersMode? TiersMode { get; set; }

    [JsonIgnore]
    public ListBillingProductPricesRequestUsageType? UsageType { get; set; }
