...
public partial class PlansClient : IPlansClient
{
    ...
    private async Task<
        WithRawResponse<MarkCustomPlanBillingPaidResponse>
    > MarkCustomPlanBillingPaidAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Put,
                    Path = string.Format(
                        "custom-plan-billings/{0}/mark-paid",
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<MarkCustomPlanBillingPaidResponse>(
                    responseBody
                )!;
                return new WithRawResponse<MarkCustomPlanBillingPaidResponse>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<MarkCustomPlanBillingPaidResponse> MarkCustomPlanBillingPaidAsync(
        string customPlanBillingId,
        Dictionary<string, object?> request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<MarkCustomPlanBillingPaidResponse>(
            MarkCustomPlanBillingPaidAsyncCore(
                customPlanBillingId,
                request,
                options,
