...
public partial class PlansClient
{
    ...
    /// <example><code>
    /// await client.Plans.ListPlanTraitsAsync(new ListPlanTraitsRequest());
    /// </code></example>
    ...
    /// <example><code>
    /// await client.Plans.CreatePlanTraitAsync(
    ...
    /// <example><code>
    /// await client.Plans.GetPlanTraitAsync("plan_trait_id");
    /// </code></example>
    ...
    /// <example><code>
    /// await client.Plans.UpdatePlanTraitAsync(
    ///     "plan_trait_id",
    ...
    /// <example><code>
    /// await client.Plans.DeletePlanTraitAsync("plan_trait_id");
    /// </code></example>
    ...
    /// <example><code>
    /// await client.Plans.CountPlanTraitsAsync(new CountPlanTraitsRequest());
    /// </code></example>
