...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<SchematicHQ.Client.Core.ApiResponse> MakeRequestAsync(
        SchematicHQ.Client.Core.BaseRequest request,
    ...
    internal async Task<SchematicHQ.Client.Core.ApiResponse> SendRequestAsync(
        SchematicHQ.Client.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<SchematicHQ.Client.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new SchematicHQ.Client.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(SchematicHQ.Client.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(SchematicHQ.Client.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use SchematicHQ.Client.Core.ApiResponse instead.")]
    internal record ApiResponse : SchematicHQ.Client.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use SchematicHQ.Client.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : SchematicHQ.Client.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use SchematicHQ.Client.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : SchematicHQ.Client.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use SchematicHQ.Client.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : SchematicHQ.Client.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use SchematicHQ.Client.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : SchematicHQ.Client.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use SchematicHQ.Client.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : SchematicHQ.Client.Core.StreamRequest;
}
