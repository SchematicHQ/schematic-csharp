...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::SchematicHQ.Client.Core.ApiResponse> SendRequestAsync(
        global::SchematicHQ.Client.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::SchematicHQ.Client.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::SchematicHQ.Client.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::SchematicHQ.Client.Core.BaseRequest request)
    {
