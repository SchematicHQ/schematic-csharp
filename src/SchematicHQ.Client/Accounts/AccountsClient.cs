...
public partial class AccountsClient : IAccountsClient
{
    ...
    private async Task<WithRawResponse<CountAccountMembersResponse>> CountAccountMembersAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CountAccountMembersResponse>(
                    responseBody
                )!;
                return new WithRawResponse<CountAccountMembersResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<GetOnboardingStateResponse>> GetOnboardingStateAsyncCore(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetOnboardingStateResponse>(responseBody)!;
                return new WithRawResponse<GetOnboardingStateResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<UpdateOnboardingStateResponse>
    > UpdateOnboardingStateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<UpdateOnboardingStateResponse>(
                    responseBody
                )!;
                return new WithRawResponse<UpdateOnboardingStateResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CountAccountMembersResponse> CountAccountMembersAsync(
        CountAccountMembersRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CountAccountMembersResponse>(
            CountAccountMembersAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<GetOnboardingStateResponse> GetOnboardingStateAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetOnboardingStateResponse>(
            GetOnboardingStateAsyncCore(options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<UpdateOnboardingStateResponse> UpdateOnboardingStateAsync(
        UpdateOnboardingStateRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<UpdateOnboardingStateResponse>(
            UpdateOnboardingStateAsyncCore(request, options, cancellationToken)
        );
    }
