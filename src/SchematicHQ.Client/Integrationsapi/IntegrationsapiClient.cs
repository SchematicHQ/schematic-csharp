...
public partial class IntegrationsapiClient : IIntegrationsapiClient
{
    ...
    private async Task<WithRawResponse<RunIntegrationResponse>> RunIntegrationAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<RunIntegrationResponse>(responseBody)!;
                return new WithRawResponse<RunIntegrationResponse>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<ListIntegrationsResponse>> ListIntegrationsAsyncCore(
    ...
    )
    {
        var _queryString = new SchematicHQ.Client.Core.QueryStringBuilder.Builder(capacity: 7)
            .Add("billing_only", request.BillingOnly)
            .Add("exclude_ids", request.ExcludeIds)
            .Add("id", request.Id)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListIntegrationsResponse>(responseBody)!;
                return new WithRawResponse<ListIntegrationsResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<StartDataImportResponse>(responseBody)!;
                return new WithRawResponse<StartDataImportResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<GetStripeSandboxClaimLinkResponse>
    > GetStripeSandboxClaimLinkAsyncCore(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetStripeSandboxClaimLinkResponse>(
                    responseBody
                )!;
                return new WithRawResponse<GetStripeSandboxClaimLinkResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<GetStripeSandboxKeysResponse>> GetStripeSandboxKeysAsyncCore(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetStripeSandboxKeysResponse>(
                    responseBody
                )!;
                return new WithRawResponse<GetStripeSandboxKeysResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<ClaimStripeSandboxKeysResponse>
    > ClaimStripeSandboxKeysAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ClaimStripeSandboxKeysResponse>(
                    responseBody
                )!;
                return new WithRawResponse<ClaimStripeSandboxKeysResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<InstallStripeClaimableSandboxResponse>
    > InstallStripeClaimableSandboxAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<InstallStripeClaimableSandboxResponse>(
                    responseBody
                )!;
                return new WithRawResponse<InstallStripeClaimableSandboxResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<ListStripeSandboxCountriesResponse>
    > ListStripeSandboxCountriesAsyncCore(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListStripeSandboxCountriesResponse>(
                    responseBody
                )!;
                return new WithRawResponse<ListStripeSandboxCountriesResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<UninstallIntegrationResponse>> UninstallIntegrationAsyncCore(
        string integrationId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<UninstallIntegrationResponse>(
                    responseBody
                )!;
                return new WithRawResponse<UninstallIntegrationResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    /// <example><code>
    /// await client.Integrationsapi.RunIntegrationAsync("integration_id");
    /// </code></example>
    public WithRawResponseTask<RunIntegrationResponse> RunIntegrationAsync(
        string integrationId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<RunIntegrationResponse>(
            RunIntegrationAsyncCore(integrationId, options, cancellationToken)
        );
    }

    /// <example><code>
    /// await client.Integrationsapi.ListIntegrationsAsync(
    ///     new ListIntegrationsRequest
    ///     {
    ///         BillingOnly = true,
    ///         ExcludeIds = new List&lt;string&gt;() { "exclude_ids" },
    ///         Id = "id",
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ListIntegrationsResponse> ListIntegrationsAsync(
        ListIntegrationsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListIntegrationsResponse>(
            ListIntegrationsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<StartDataImportResponse> StartDataImportAsync(
        StartDataImportRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<StartDataImportResponse>(
            StartDataImportAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<GetStripeSandboxClaimLinkResponse> GetStripeSandboxClaimLinkAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetStripeSandboxClaimLinkResponse>(
            GetStripeSandboxClaimLinkAsyncCore(options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<GetStripeSandboxKeysResponse> GetStripeSandboxKeysAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetStripeSandboxKeysResponse>(
            GetStripeSandboxKeysAsyncCore(options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ClaimStripeSandboxKeysResponse> ClaimStripeSandboxKeysAsync(
        ClaimStripeSandboxKeysRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ClaimStripeSandboxKeysResponse>(
            ClaimStripeSandboxKeysAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<InstallStripeClaimableSandboxResponse> InstallStripeClaimableSandboxAsync(
        InstallStripeSandboxRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<InstallStripeClaimableSandboxResponse>(
            InstallStripeClaimableSandboxAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<ListStripeSandboxCountriesResponse> ListStripeSandboxCountriesAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListStripeSandboxCountriesResponse>(
            ListStripeSandboxCountriesAsyncCore(options, cancellationToken)
        );
    }

    /// <example><code>
    /// await client.Integrationsapi.UninstallIntegrationAsync("integration_id");
    /// </code></example>
    public WithRawResponseTask<UninstallIntegrationResponse> UninstallIntegrationAsync(
        string integrationId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<UninstallIntegrationResponse>(
            UninstallIntegrationAsyncCore(integrationId, options, cancellationToken)
        );
    }
}
