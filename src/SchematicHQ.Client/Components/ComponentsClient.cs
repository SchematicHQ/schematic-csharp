...
public partial class ComponentsClient : IComponentsClient
{
    ...
    private async Task<WithRawResponse<BindCatalogResponse>> BindCatalogAsyncCore(
        string componentId,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<BindCatalogResponse>(responseBody)!;
                return new WithRawResponse<BindCatalogResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<BindCatalogResponse> BindCatalogAsync(
        string componentId,
        BindCatalogRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<BindCatalogResponse>(
