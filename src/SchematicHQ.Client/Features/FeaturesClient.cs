...
public partial class FeaturesClient : IFeaturesClient
{
    ...
    private async Task<WithRawResponse<CheckAndReserveFlagResponse>> CheckAndReserveFlagAsyncCore(
        string key,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CheckAndReserveFlagResponse>(
                    responseBody
                )!;
                return new WithRawResponse<CheckAndReserveFlagResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<CheckAndReserveFlagResponse> CheckAndReserveFlagAsync(
        string key,
        CheckAndReserveFlagRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<CheckAndReserveFlagResponse>(
            CheckAndReserveFlagAsyncCore(key, request, options, cancellationToken)
        );
    }
