...
[JsonConverter(
    typeof(RulesengineTraitDefinitionComparableType.RulesengineTraitDefinitionComparableTypeSerializer)
)]
[Serializable]
public readonly record struct RulesengineTraitDefinitionComparableType : IStringEnum
{
    ...
    internal class RulesengineTraitDefinitionComparableTypeSerializer
        : JsonConverter<RulesengineTraitDefinitionComparableType>
    {
        public override RulesengineTraitDefinitionComparableType Read(
        ...
        )
        {
            ...
            return new RulesengineTraitDefinitionComparableType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            RulesengineTraitDefinitionComparableType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override RulesengineTraitDefinitionComparableType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
