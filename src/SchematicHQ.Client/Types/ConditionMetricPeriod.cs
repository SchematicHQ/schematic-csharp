...
[JsonConverter(typeof(ConditionMetricPeriod.ConditionMetricPeriodSerializer))]
[Serializable]
public readonly record struct ConditionMetricPeriod : IStringEnum
{
    ...
    internal class ConditionMetricPeriodSerializer : JsonConverter<ConditionMetricPeriod>
    {
        public override ConditionMetricPeriod Read(
        ...
        )
        {
            ...
            return new ConditionMetricPeriod(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ConditionMetricPeriod value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ConditionMetricPeriod ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
