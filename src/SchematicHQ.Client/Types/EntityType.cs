...
[JsonConverter(typeof(EntityType.EntityTypeSerializer))]
[Serializable]
public readonly record struct EntityType : IStringEnum
{
    public static readonly EntityType Company = new(Values.Company);
    ...
    internal class EntityTypeSerializer : JsonConverter<EntityType>
    {
        ...
        )
        {
            ...
            return new EntityType(stringValue);
        }
        ...
        public override EntityType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
