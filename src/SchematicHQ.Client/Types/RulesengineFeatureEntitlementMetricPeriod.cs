...
[JsonConverter(
    typeof(RulesengineFeatureEntitlementMetricPeriod.RulesengineFeatureEntitlementMetricPeriodSerializer)
)]
[Serializable]
public readonly record struct RulesengineFeatureEntitlementMetricPeriod : IStringEnum
{
    ...
    internal class RulesengineFeatureEntitlementMetricPeriodSerializer
        : JsonConverter<RulesengineFeatureEntitlementMetricPeriod>
    {
        public override RulesengineFeatureEntitlementMetricPeriod Read(
        ...
        )
        {
            ...
            return new RulesengineFeatureEntitlementMetricPeriod(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            RulesengineFeatureEntitlementMetricPeriod value,
            JsonSerializerOptions options
        )
        {
        ...
        public override RulesengineFeatureEntitlementMetricPeriod ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
