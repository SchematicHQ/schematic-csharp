...
[Serializable]
public record CompanyViewWithFeatureUsageResponseData : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<FeatureUsageDataResponseData> FeatureUsage { get; set; } =
        new List<FeatureUsageDataResponseData>();
