...
[JsonConverter(typeof(ActorType.ActorTypeSerializer))]
[Serializable]
public readonly record struct ActorType : IStringEnum
{
    ...
    internal class ActorTypeSerializer : JsonConverter<ActorType>
    {
        ...
        )
        {
            ...
            return new ActorType(stringValue);
        }
        ...
        public override ActorType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
