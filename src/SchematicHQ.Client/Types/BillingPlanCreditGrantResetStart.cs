...
[JsonConverter(typeof(BillingPlanCreditGrantResetStart.BillingPlanCreditGrantResetStartSerializer))]
[Serializable]
public readonly record struct BillingPlanCreditGrantResetStart : IStringEnum
{
    ...
    internal class BillingPlanCreditGrantResetStartSerializer
        : JsonConverter<BillingPlanCreditGrantResetStart>
    {
        public override BillingPlanCreditGrantResetStart Read(
        ...
        )
        {
            ...
            return new BillingPlanCreditGrantResetStart(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            BillingPlanCreditGrantResetStart value,
            JsonSerializerOptions options
        )
        {
        ...
        public override BillingPlanCreditGrantResetStart ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
