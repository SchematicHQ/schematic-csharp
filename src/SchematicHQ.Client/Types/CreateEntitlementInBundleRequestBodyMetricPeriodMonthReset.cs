...
[JsonConverter(
    typeof(CreateEntitlementInBundleRequestBodyMetricPeriodMonthReset.CreateEntitlementInBundleRequestBodyMetricPeriodMonthResetSerializer)
)]
[Serializable]
    ...
    : IStringEnum
{
    ...
    internal class CreateEntitlementInBundleRequestBodyMetricPeriodMonthResetSerializer
        : JsonConverter<CreateEntitlementInBundleRequestBodyMetricPeriodMonthReset>
    {
        public override CreateEntitlementInBundleRequestBodyMetricPeriodMonthReset Read(
        ...
        )
        {
            ...
            return new CreateEntitlementInBundleRequestBodyMetricPeriodMonthReset(stringValue);
        }
        ...
        public override CreateEntitlementInBundleRequestBodyMetricPeriodMonthReset ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
