...
[JsonConverter(
    typeof(RulesengineCheckFlagResultFeatureUsagePeriod.RulesengineCheckFlagResultFeatureUsagePeriodSerializer)
)]
[Serializable]
public readonly record struct RulesengineCheckFlagResultFeatureUsagePeriod : IStringEnum
{
    ...
    internal class RulesengineCheckFlagResultFeatureUsagePeriodSerializer
        : JsonConverter<RulesengineCheckFlagResultFeatureUsagePeriod>
    {
        public override RulesengineCheckFlagResultFeatureUsagePeriod Read(
        ...
        )
        {
            ...
            return new RulesengineCheckFlagResultFeatureUsagePeriod(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            RulesengineCheckFlagResultFeatureUsagePeriod value,
            JsonSerializerOptions options
        )
        {
        ...
        public override RulesengineCheckFlagResultFeatureUsagePeriod ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
