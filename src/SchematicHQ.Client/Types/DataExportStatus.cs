...
[JsonConverter(typeof(DataExportStatus.DataExportStatusSerializer))]
[Serializable]
public readonly record struct DataExportStatus : IStringEnum
{
    ...
    internal class DataExportStatusSerializer : JsonConverter<DataExportStatus>
    {
        public override DataExportStatus Read(
        ...
        )
        {
            ...
            return new DataExportStatus(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            DataExportStatus value,
            JsonSerializerOptions options
        )
        {
        ...
        public override DataExportStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
