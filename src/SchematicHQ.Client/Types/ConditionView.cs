...
[Serializable]
public record ConditionView : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    [JsonPropertyName("billing_products")]
    public IEnumerable<GenericPreviewObject> BillingProducts { get; set; } =
        new List<GenericPreviewObject>();

    [JsonPropertyName("companies")]
    public IEnumerable<GenericPreviewObject> Companies { get; set; } =
        new List<GenericPreviewObject>();
    ...
    public IEnumerable<GenericPreviewObject> Users { get; set; } = new List<GenericPreviewObject>();
