...
[JsonConverter(typeof(ConditionConditionType.ConditionConditionTypeSerializer))]
[Serializable]
public readonly record struct ConditionConditionType : IStringEnum
{
    ...
    internal class ConditionConditionTypeSerializer : JsonConverter<ConditionConditionType>
    {
        public override ConditionConditionType Read(
        ...
        )
        {
            ...
            return new ConditionConditionType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ConditionConditionType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ConditionConditionType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
