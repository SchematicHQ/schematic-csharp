...
public partial class CreditsClient : ICreditsClient
{
    ...
    private async Task<
        WithRawResponse<ListCompanyCreditBalancesResponse>
    > ListCompanyCreditBalancesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListCompanyCreditBalancesResponse>(
                    responseBody
                )!;
                return new WithRawResponse<ListCompanyCreditBalancesResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<AcquireCreditLeaseResponse>> AcquireCreditLeaseAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AcquireCreditLeaseResponse>(responseBody)!;
                return new WithRawResponse<AcquireCreditLeaseResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<ExtendCreditLeaseResponse>> ExtendCreditLeaseAsyncCore(
        string leaseId,
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Put,
                    Path = string.Format(
                        "billing/credits/lease/{0}/extend",
                        ValueConvert.ToPathParameterString(leaseId)
                    ),
                    Body = request,
                    QueryString = _queryString,
                    Headers = _headers,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ExtendCreditLeaseResponse>(responseBody)!;
                return new WithRawResponse<ExtendCreditLeaseResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<ReleaseCreditLeaseResponse>> ReleaseCreditLeaseAsyncCore(
        string leaseId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Put,
                    Path = string.Format(
                        "billing/credits/lease/{0}/release",
                        ValueConvert.ToPathParameterString(leaseId)
                    ),
                    QueryString = _queryString,
                    Headers = _headers,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ReleaseCreditLeaseResponse>(responseBody)!;
                return new WithRawResponse<ReleaseCreditLeaseResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<GetSingleBillingPlanCreditGrantResponse>
    > GetSingleBillingPlanCreditGrantAsyncCore(
        string planGrantId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetSingleBillingPlanCreditGrantResponse>(
                    responseBody
                )!;
                return new WithRawResponse<GetSingleBillingPlanCreditGrantResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<ReserveCreditsResponse>> ReserveCreditsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ReserveCreditsResponse>(responseBody)!;
                return new WithRawResponse<ReserveCreditsResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<ReleaseCreditReservationResponse>
    > ReleaseCreditReservationAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Put,
                    Path = string.Format(
                        "billing/credits/reservations/{0}/release",
                        ValueConvert.ToPathParameterString(reservationId)
                    ),
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ReleaseCreditReservationResponse>(
                    responseBody
                )!;
                return new WithRawResponse<ReleaseCreditReservationResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<ListCreditSpendPoliciesResponse>
    > ListCreditSpendPoliciesAsyncCore(
    ...
    )
    {
        var _queryString = new SchematicHQ.Client.Core.QueryStringBuilder.Builder(capacity: 7)
            ...
            .Add("company_id", request.CompanyId)
            .Add("scope_type", request.ScopeType)
            .Add("user_id", request.UserId)
            .Add("user_ids", request.UserIds)
            .Add("limit", request.Limit)
            .Add("offset", request.Offset)
            .MergeAdditional(options?.AdditionalQueryParameters)
            .Build();
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListCreditSpendPoliciesResponse>(
                    responseBody
                )!;
                return new WithRawResponse<ListCreditSpendPoliciesResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<CreateCreditSpendPolicyResponse>
    > CreateCreditSpendPolicyAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CreateCreditSpendPolicyResponse>(
                    responseBody
                )!;
                return new WithRawResponse<CreateCreditSpendPolicyResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<GetCreditSpendPolicyResponse>> GetCreditSpendPolicyAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Get,
                    Path = string.Format(
                        "billing/credits/spend-policies/{0}",
                        ValueConvert.ToPathParameterString(spendPolicyId)
                    ),
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetCreditSpendPolicyResponse>(
                    responseBody
                )!;
                return new WithRawResponse<GetCreditSpendPolicyResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<UpdateCreditSpendPolicyResponse>
    > UpdateCreditSpendPolicyAsyncCore(
        string spendPolicyId,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<UpdateCreditSpendPolicyResponse>(
                    responseBody
                )!;
                return new WithRawResponse<UpdateCreditSpendPolicyResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<DeleteCreditSpendPolicyResponse>
    > DeleteCreditSpendPolicyAsyncCore(
        string spendPolicyId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DeleteCreditSpendPolicyResponse>(
                    responseBody
                )!;
                return new WithRawResponse<DeleteCreditSpendPolicyResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<CountCreditSpendPoliciesResponse>
    > CountCreditSpendPoliciesAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CountCreditSpendPoliciesResponse>(
                    responseBody
                )!;
                return new WithRawResponse<CountCreditSpendPoliciesResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ListCompanyCreditBalancesResponse> ListCompanyCreditBalancesAsync(
        ListCompanyCreditBalancesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListCompanyCreditBalancesResponse>(
            ListCompanyCreditBalancesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AcquireCreditLeaseResponse> AcquireCreditLeaseAsync(
        AcquireCreditLeaseRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AcquireCreditLeaseResponse>(
            AcquireCreditLeaseAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ExtendCreditLeaseResponse> ExtendCreditLeaseAsync(
        string leaseId,
        ExtendCreditLeaseRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<ExtendCreditLeaseResponse>(
            ExtendCreditLeaseAsyncCore(leaseId, request, options, cancellationToken)
        );
    }

    /// <example><code>
    /// await client.Credits.ReleaseCreditLeaseAsync("lease_id");
    /// </code></example>
    public WithRawResponseTask<ReleaseCreditLeaseResponse> ReleaseCreditLeaseAsync(
        string leaseId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ReleaseCreditLeaseResponse>(
            ReleaseCreditLeaseAsyncCore(leaseId, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<GetSingleBillingPlanCreditGrantResponse> GetSingleBillingPlanCreditGrantAsync(
        string planGrantId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetSingleBillingPlanCreditGrantResponse>(
            GetSingleBillingPlanCreditGrantAsyncCore(planGrantId, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ReserveCreditsResponse> ReserveCreditsAsync(
        ReserveCreditsRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ReserveCreditsResponse>(
            ReserveCreditsAsyncCore(request, options, cancellationToken)
        );
    }

    /// <example><code>
    /// await client.Credits.ReleaseCreditReservationAsync("reservation_id");
    /// </code></example>
    public WithRawResponseTask<ReleaseCreditReservationResponse> ReleaseCreditReservationAsync(
        string reservationId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ReleaseCreditReservationResponse>(
            ReleaseCreditReservationAsyncCore(reservationId, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<ListCreditSpendPoliciesResponse> ListCreditSpendPoliciesAsync(
        ListCreditSpendPoliciesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListCreditSpendPoliciesResponse>(
            ListCreditSpendPoliciesAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CreateCreditSpendPolicyResponse> CreateCreditSpendPolicyAsync(
        CreateCreditSpendPolicyRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CreateCreditSpendPolicyResponse>(
            CreateCreditSpendPolicyAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<GetCreditSpendPolicyResponse> GetCreditSpendPolicyAsync(
        string spendPolicyId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetCreditSpendPolicyResponse>(
            GetCreditSpendPolicyAsyncCore(spendPolicyId, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<UpdateCreditSpendPolicyResponse> UpdateCreditSpendPolicyAsync(
        string spendPolicyId,
        UpdateCreditSpendPolicyRequestBody request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateCreditSpendPolicyResponse>(
            UpdateCreditSpendPolicyAsyncCore(spendPolicyId, request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<DeleteCreditSpendPolicyResponse> DeleteCreditSpendPolicyAsync(
        string spendPolicyId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DeleteCreditSpendPolicyResponse>(
            DeleteCreditSpendPolicyAsyncCore(spendPolicyId, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CountCreditSpendPoliciesResponse> CountCreditSpendPoliciesAsync(
        CountCreditSpendPoliciesRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CountCreditSpendPoliciesResponse>(
            CountCreditSpendPoliciesAsyncCore(request, options, cancellationToken)
        );
    }
