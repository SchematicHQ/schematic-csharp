...
public partial class CompaniesClient : ICompaniesClient
{
    ...
    private async Task<
        WithRawResponse<GetCompanyBillingEntityResponse>
    > GetCompanyBillingEntityAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetCompanyBillingEntityResponse>(
                    responseBody
                )!;
                return new WithRawResponse<GetCompanyBillingEntityResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<GetBillingEntityChildSubscriptionsResponse>
    > GetBillingEntityChildSubscriptionsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<GetBillingEntityChildSubscriptionsResponse>(
                        responseBody
                    )!;
                return new WithRawResponse<GetBillingEntityChildSubscriptionsResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<DeleteEntityKeyDefinitionResponse>
    > DeleteEntityKeyDefinitionAsyncCore(
    ...
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Delete,
                    Path = string.Format(
                        "entity-key-definitions/{0}",
                        ValueConvert.ToPathParameterString(entityKeyDefinitionId)
                    ),
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DeleteEntityKeyDefinitionResponse>(
                    responseBody
                )!;
                return new WithRawResponse<DeleteEntityKeyDefinitionResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<CountEntityKeysResponse>> CountEntityKeysAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CountEntityKeysResponse>(responseBody)!;
                return new WithRawResponse<CountEntityKeysResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<DeleteEntityTraitDefinitionResponse>
    > DeleteEntityTraitDefinitionAsyncCore(
        string entityTraitDefinitionId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<DeleteEntityTraitDefinitionResponse>(
                    responseBody
                )!;
                return new WithRawResponse<DeleteEntityTraitDefinitionResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<GetEntityTraitDefinitionUsageResponse>
    > GetEntityTraitDefinitionUsageAsyncCore(
        string entityTraitDefinitionId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Get,
                    Path = string.Format(
                        "entity-trait-definitions/{0}/usage",
                        ValueConvert.ToPathParameterString(entityTraitDefinitionId)
                    ),
                    QueryString = _queryString,
                    Headers = _headers,
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetEntityTraitDefinitionUsageResponse>(
                    responseBody
                )!;
                return new WithRawResponse<GetEntityTraitDefinitionUsageResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<CountEntityTraitsResponse>> CountEntityTraitsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CountEntityTraitsResponse>(responseBody)!;
                return new WithRawResponse<CountEntityTraitsResponse>()
                {
                    Data = responseData,
                    RawResponse = new SchematicHQ.Client.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<GetCompanyBillingEntityResponse> GetCompanyBillingEntityAsync(
        GetCompanyBillingEntityRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetCompanyBillingEntityResponse>(
            GetCompanyBillingEntityAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<GetBillingEntityChildSubscriptionsResponse> GetBillingEntityChildSubscriptionsAsync(
        GetBillingEntityChildSubscriptionsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetBillingEntityChildSubscriptionsResponse>(
            GetBillingEntityChildSubscriptionsAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<DeleteEntityKeyDefinitionResponse> DeleteEntityKeyDefinitionAsync(
        string entityKeyDefinitionId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DeleteEntityKeyDefinitionResponse>(
            DeleteEntityKeyDefinitionAsyncCore(entityKeyDefinitionId, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CountEntityKeysResponse> CountEntityKeysAsync(
        CountEntityKeysRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CountEntityKeysResponse>(
            CountEntityKeysAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<DeleteEntityTraitDefinitionResponse> DeleteEntityTraitDefinitionAsync(
        string entityTraitDefinitionId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<DeleteEntityTraitDefinitionResponse>(
            DeleteEntityTraitDefinitionAsyncCore(
                entityTraitDefinitionId,
                options,
                cancellationToken
    ...
    /// </code></example>
    public WithRawResponseTask<GetEntityTraitDefinitionUsageResponse> GetEntityTraitDefinitionUsageAsync(
        string entityTraitDefinitionId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetEntityTraitDefinitionUsageResponse>(
            GetEntityTraitDefinitionUsageAsyncCore(
                entityTraitDefinitionId,
                options,
                cancellationToken
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CountEntityTraitsResponse> CountEntityTraitsAsync(
        CountEntityTraitsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CountEntityTraitsResponse>(
            CountEntityTraitsAsyncCore(request, options, cancellationToken)
        );
    }
