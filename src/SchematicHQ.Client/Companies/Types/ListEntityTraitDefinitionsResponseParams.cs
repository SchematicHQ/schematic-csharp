...
/// </summary>
[Serializable]
public record ListEntityTraitDefinitionsResponseParams : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<ListEntityTraitDefinitionsResponseParamsTraitTypesItem>? TraitTypes { get; set; }
