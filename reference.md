...
await client.Companies.GetActiveCompanySubscriptionAsync(
    new GetActiveCompanySubscriptionRequest { CompanyId = "company_id" }
);
```
</dd>
</dl>
...
<details><summary><code>client.Events.<a href="/src/SchematicHQ.Client/Events/EventsClient.cs">ListMetricCountsAsync</a>(ListMetricCountsRequest { ... }) -> ListMetricCountsResponse</code></summary>
<dl>
<dd>
...
```csharp
await client.Events.ListMetricCountsAsync(new ListMetricCountsRequest());
```
</dd>
</dl>
</dd>
...
**request:** `ListMetricCountsRequest` 
...
await client.Plans.UpsertBillingProductPlanAsync(
    "plan_id",
    new UpsertBillingProductRequestBody { BillingProductId = "billing_product_id" }
);
```
</dd>
</dl>
